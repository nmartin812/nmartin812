...
| -------------- | ------------- | ------------- | ------------- |
| [Regression with an Insurance Dataset](https://github.com/nmartin812/projects/blob/main/Insurance%20Premiums.ipynb) | Regression | Predict insurance premiums based on various factors. |
